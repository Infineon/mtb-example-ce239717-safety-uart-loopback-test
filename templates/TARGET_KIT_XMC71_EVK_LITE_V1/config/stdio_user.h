...
* the Retarget I/O files use SCB7. The stdio_user.h file defines these macros:
* \code #define IO_STDOUT_UART      SCB7 
*  #define IO_STDIN_UART       SCB7  \endcode
*
...
#define IO_STDOUT_UART      SCB7
#define IO_STDIN_UART       SCB7
